package cn.com.jiahang.core.common.util.dynamic.db;

import cn.com.jiahang.core.common.exception.AppException;
import cn.com.jiahang.core.common.system.vo.DynamicDataSourceModel;
import cn.com.jiahang.core.common.util.ReflectHelper;
    ...
    public static DruidDataSource getDbSourceByDbKey(final String dbKey) {
        ...
        if (cacheDbSource != null && !cacheDbSource.isClosed()) {
            ...
            if (dataSource != null && dataSource.isEnable()) {
                ...
                throw new AppException("动态数据源连接失败，dbKey：" + dbKey);
            }
