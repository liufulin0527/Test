package cn.com.jiahang.core.common.es;

import cn.com.jiahang.core.common.util.RestUtil;
...
public class ElasticsearchTemplate {
    ...
    public ElasticsearchTemplate(@Value("${jeecg.elasticsearch.cluster-nodes}") String baseUrl, @Value("${jeecg.elasticsearch.check-enabled}") boolean checkEnabled) {
