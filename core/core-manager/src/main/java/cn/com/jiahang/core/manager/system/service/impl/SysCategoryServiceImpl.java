...
import cn.com.jiahang.core.common.constant.FillRuleConstant;
import cn.com.jiahang.core.common.exception.AppException;
import cn.com.jiahang.core.common.util.FillRuleUtil;
import cn.com.jiahang.core.common.util.oConvertUtils;
import cn.com.jiahang.core.manager.system.entity.SysCategory;
import cn.com.jiahang.core.manager.system.mapper.SysCategoryMapper;
import cn.com.jiahang.core.manager.system.model.TreeSelectModel;
import cn.com.jiahang.core.manager.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws AppException {
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new AppException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new AppException("该编码【"+pcode+"】存在多个，请核实!");
			}
