...
import cn.com.jiahang.core.common.system.vo.*;
import cn.com.jiahang.core.common.util.IPUtils;
import cn.com.jiahang.core.common.util.SpringContextUtils;
import cn.com.jiahang.core.common.util.SysAnnmentTypeEnum;
...
import cn.com.jiahang.core.manager.message.websocket.WebSocket;
import cn.com.jiahang.core.manager.system.entity.*;
import cn.com.jiahang.core.manager.system.mapper.*;
...
import cn.com.jiahang.core.common.constant.DataBaseConstant;
import cn.com.jiahang.core.common.constant.WebsocketConst;
import cn.com.jiahang.core.common.exception.AppException;
import cn.com.jiahang.core.common.system.api.ISysBaseAPI;
import cn.com.jiahang.core.manager.system.service.ISysDataSourceService;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(String templateCode,Map<String, String> map) {
        ...
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new AppException("消息模板不存在，模板编码："+templateCode);
        }
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new AppException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
