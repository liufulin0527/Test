...
import cn.com.jiahang.core.manager.system.util.TenantContext;
...
import cn.com.jiahang.core.manager.config.mybatis.MyTenantParser;
 ...
 */
@Configuration
@MapperScan(value={"cn.com.jiahang.core.manager.**.mapper*"})
