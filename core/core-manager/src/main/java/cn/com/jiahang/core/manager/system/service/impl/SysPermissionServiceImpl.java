...
import cn.com.jiahang.core.common.exception.AppException;
import cn.com.jiahang.core.common.util.oConvertUtils;
import cn.com.jiahang.core.manager.system.entity.SysPermission;
import cn.com.jiahang.core.manager.system.entity.SysPermissionDataRule;
import cn.com.jiahang.core.manager.system.mapper.SysDepartPermissionMapper;
import cn.com.jiahang.core.manager.system.mapper.SysDepartRolePermissionMapper;
import cn.com.jiahang.core.manager.system.mapper.SysPermissionMapper;
import cn.com.jiahang.core.manager.system.mapper.SysRolePermissionMapper;
import cn.com.jiahang.core.manager.system.model.TreeModel;
import cn.com.jiahang.core.manager.system.service.ISysPermissionDataRuleService;
import cn.com.jiahang.core.manager.system.service.ISysPermissionService;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws AppException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new AppException("未找到菜单信息");
		}
	...
	public void deletePermissionLogical(String id) throws AppException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new AppException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws AppException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws AppException {
